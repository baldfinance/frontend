          ...
          {unsupportedV2Network ? (
            ...
            <AutoColumn gap="lg" justify="center">
              <AutoColumn gap="md" style={{ width: '100%' }}>
                <TitleRow style={{ marginTop: '1rem' }} padding="0">
                  <HideSmall>
                    <ThemedText.DeprecatedMediumHeader
                      style={{ marginTop: '0.5rem', justifySelf: 'flex-start', color: 'white' }}
                    >
                      <Trans>Your liquidity</Trans>
                    </ThemedText.DeprecatedMediumHeader>
                  </HideSmall>
                  <ButtonRow>
                    <ResponsiveButtonPrimary as={Link} to="/add/ETH">
                      <Text fontWeight={500} fontSize={16}>
                        <Trans>Create a pair</Trans>
                      </Text>
                    </ResponsiveButtonPrimary>
                    <ResponsiveButtonPrimary id="find-pool-button" as={Link} to="/pools/find" padding="6px 8px">
                      <Text fontWeight={500} fontSize={16}>
                ...
                {!account ? (
                  <Card padding="40px">
                    <ThemedText.DeprecatedBody color="white" textAlign="center">

...
export const darkTheme = {
  ...
  stateOverlayHover: opacify(8, colors.white),
  stateOverlayPressed: opacify(24, colors.white),
...
export const lightTheme: Theme = {
  ...
  background: colors.coinbase.primary, //INTENTIONALLY OFF THEME TO GIVE WHITE BG A SOFTER VISUAL
  ...
  accentAction: colors.coinbase.primary,
  accentActive: colors.blue400,
  ...
  accentActionSoft: opacify(12, colors.coinbase.primary),
  accentActiveSoft: opacify(24, colors.blue400),
  ...
  accentTextDarkSecondary: opacify(60, colors.white),
  accentTextDarkTertiary: opacify(24, colors.white),

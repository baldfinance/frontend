...
import { V2_ROUTER_ADDRESSES } from 'constants/routing'
...
export function useV2RouterContract(chainId: number | undefined): Contract | null {
  if (!chainId) return null
  return useContract(V2_ROUTER_ADDRESSES[chainId], IUniswapV2Router02ABI, true)
}
